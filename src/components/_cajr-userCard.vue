<template>
  <div class="cajr-cardlist">
    <div class="cajr-cardlist-item" v-for="item in datas" :key="item.title">
      <img :src="item.image_url" alt />
      <div class="cajr-cardItem-name">{{ item.title }}</div>
      <div class="cajr-cardItem-intro">{{ item.intro }}</div>
